...
<<<<<<< HEAD
    ...
    {"key": "NOT_PUT_DOWN", "title_en": "Not put down the rack", "title_vi": "Không hạ rack",
     "steps_en": ["Move"], "steps_vi": ["Di chuyển"]},
    {"key": "TRANSFER_RACK", "title_en": "Transfer rack", "title_vi": "Chuyển rack",
     "steps_en": ["Move", "Lift", "Move", "Putdown"], "steps_vi": ["Di chuyển", "Nâng", "Di chuyển", "Hạ"]},
    {"key": "PALLETS_OUTBOUND", "title_en": "Pallets Outbound", "title_vi": "Xuất pallet",
     "steps_en": ["Move", "Putdown"], "steps_vi": ["Di chuyển", "Hạ"]},
    {"key": "PALLETS_INBOUND", "title_en": "Pallets Inbound", "title_vi": "Nhập pallet",
     "steps_en": ["Move", "Putdown"], "steps_vi": ["Di chuyển", "Hạ"]},
    {"key": "MOVE_CARTON", "title_en": "Move Carton", "title_vi": "Di chuyển thùng carton",
     "steps_en": ["Move", "Putdown"], "steps_vi": ["Di chuyển", "Hạ"]},
]
