...
class ModbusLoRa : public Modbus {
    private:
        ...
        int send_cmd_lora(char * cmd, bool printCmdRes, bool doubleRes);
    ...
    public:
        ...
        #ifndef DEBUG_MODE
        void configLoRa(HardwareSerial* port, long baud, unsigned char resetpin);
        #endif

        #ifdef DEBUG_MODE
        void configLoRa(HardwareSerial* port, HardwareSerial* DebugSerialPort,
                        long baud,
                        unsigned char resetpin);
        #endif
};
